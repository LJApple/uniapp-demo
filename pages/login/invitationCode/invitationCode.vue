			...
			<view class="lc-inter">
				<view class="lci-form">
					<u--form labelPosition="top" :model="form" :rules="rules" ref="form">
						<u-form-item labelWidth="100%" label="邀請碼（非必選項）" prop="invitationCode" ref="invitationCode">
							<u--input class="lcif-input" inputAlign="left" v-model="form.invitationCode" placeholder="請輸入你的邀請碼"
								></u--input>
						</u-form-item>
					</u--form>
				</view>
