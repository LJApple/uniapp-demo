					...
					<view class="psd-sus">
						<view class="psds-li">
							...
							<view class="psdsl-bottom">
								<view class="flex"><text>{{item.coin}}</text><text class="f-mut" v-if="item.multiple">X{{item.multiple}}</text></view>
								<view class="pb-btn">激进</view>
							</view>
						</view>
						<view class="psds-li">
							<view class="psdsl-top">持仓资产USDT</view>
							<view class="psdsl-bottom">{{item.hasUSDT}}</view>
						</view>
						<view class="psds-li">
							<view class="psdsl-top">价格USDT</view>
							<view class="psdsl-bottom">{{item.priceUSDT}}</view>
						</view>
					</view>
					<view class="psd-bottom">
						<view class="psdbs-li">
							<view class="psdsl-top">当前持仓保证金</view>
...
<script>
	export default {
		...
		onLoad() {
			// uni.getSystemInfo({
			// 	success: (res) => {
			// 		let height = res.screenHeight - uni.upx2px(320)
