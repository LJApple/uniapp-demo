    ...
    return function(modules) {
            ...
            _createClass(AjaxEngine2, [{
              ...
              value: function send(arg) {
                ...
                if (adapter) {
                  ...
                  util.merge(request2, self2._options || {});
                  ...
                  request2.timeout = self2.timeout;
                  adapter(request2, function(response) {
      ...
      function(module2, exports3, __webpack_require__) {
        ...
        var Fly2 = function() {
          ...
          _createClass(Fly3, [{
            key: "request",
            value: function request2(url, data, options) {
              var _this = this;
      ...
      ,
      function(module2, exports3, __webpack_require__) {
        module2.exports = function(request2, responseCallback) {
          var con = {
            method: request2.method,
            url: request2.url,
            dataType: request2.dataType || void 0,
            header: request2.headers,
            data: request2.body || {},
            responseType: request2.responseType || "text",
